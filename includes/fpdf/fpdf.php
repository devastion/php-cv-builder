...
class FPDF
{
    ...
    function CreateCell($fontEmphasis, $fontSize, $width, $height, $text, $ln, $align, $left, $top, $right, $isMultiCell)
    {
        $this->SetMargins($left, $top, $right);
        $this->SetFont('Arial', $fontEmphasis, $fontSize);
        if ($isMultiCell) {
            $this->MultiCell($width, $height, $text, 0, $align);
        } else {
            $this->Cell($width, $height, $text, 0, $ln, $align, false, '');
        }
    }
